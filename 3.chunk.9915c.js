...
var className = __webpack_require__("9qb7");
var debounce = __webpack_require__("4PZ+");
var isEqual = __webpack_require__("/a1X");
var createReactClass = __webpack_require__("9qxo");
...
var CodeMirror = createReactClass({
	...
	getCodeMirrorInstance: function getCodeMirrorInstance() {
		return this.props.codeMirrorInstance || __webpack_require__("tQq4");
	},
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_codemirror__ = __webpack_require__("CQ/g");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_codemirror___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react_codemirror__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reducers_input__ = __webpack_require__("jJUk");
...
__webpack_require__("DcmQ");
__webpack_require__("kFQv");
__webpack_require__("fI8Q");
const style = __webpack_require__("iZxP");
let CodeInput = class CodeInput extends __WEBPACK_IMPORTED_MODULE_0_preact__["Component"] {
    constructor(props) {
        super(props);
    ...
    render(props) {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_2_react_codemirror___default.a, { mode: 'stex', options: {
                theme: props.darkTheme ? 'monokai' : 'default'
            }, ref: el => { this.codeMirrorElm = el; }, className: style.codeInput, value: this.props.latex, onChange: this.onInputChange }));
    }
};
CodeInput = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(state => ({
        latex: state.input.latex,
        darkTheme: state.general.darkTheme
    }), __WEBPACK_IMPORTED_MODULE_3__reducers_input__["a" /* actions */])
], CodeInput);
/* harmony default export */ __webpack_exports__["default"] = (CodeInput);
...
//# sourceMappingURL=3.chunk.9915c.js.map