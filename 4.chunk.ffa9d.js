...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_exports_loader_window_MathQuill_imports_loader_window_jQuery_jquery_mathquill_build_mathquill_js__ = __webpack_require__("YgGZ");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_exports_loader_window_MathQuill_imports_loader_window_jQuery_jquery_mathquill_build_mathquill_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_exports_loader_window_MathQuill_imports_loader_window_jQuery_jquery_mathquill_build_mathquill_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mathquill_build_mathquill_css__ = __webpack_require__("3co7");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mathquill_build_mathquill_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_mathquill_build_mathquill_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__style_sass__ = __webpack_require__("alq/");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__reducers_input__ = __webpack_require__("jJUk");
var _dec, _class;
...
var InputField = (_dec = Object(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(function (state) {
  return {
    latex: state.input.latex
  };
}, __WEBPACK_IMPORTED_MODULE_5__reducers_input__["a" /* actions */]), _dec(_class = function (_Component) {
  ...
  function InputField(props) {
    ...
    _this.mathElement = null;
    _this.mathField = null;
    return _this;
  }

  InputField.prototype.componentDidMount = function componentDidMount() {
    var self = this;
    ...
    this.mathField = __WEBPACK_IMPORTED_MODULE_2_exports_loader_window_MathQuill_imports_loader_window_jQuery_jquery_mathquill_build_mathquill_js___default.a.MathField(this.mathElement, config);
    this.mathField.latex(this.props.latex);
  };

  InputField.prototype.render = function render(props) {
    var _this2 = this;
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('div', { className: __WEBPACK_IMPORTED_MODULE_4__style_sass___default.a.inputfield, ref: function ref(x) {
        _this2.mathElement = x;
      } });
  };
...
var window = (window || {});
window.jQuery = __webpack_require__("juYr");
...
(function () {
  ...
  function getInterface(v) {
    ...
    MQ.config = function (opts) {
      config(Options.p, opts);return this;
    };
    ...
    var AbstractMathQuill = APIClasses.AbstractMathQuill = P(Progenote, function (_) {
      ...
      _.config = function (opts) {
        config(this.__options, opts);return this;
      };
      _.el = function () {
    ...
    APIClasses.EditableField = P(AbstractMathQuill, function (_, super_) {
      ...
      _.focus = function () {
        this.__controller.textarea.focus();return this;
      };
      _.blur = function () {
        this.__controller.textarea.blur();return this;
      };
  ...
  Node.open(function (_) {
    _.keystroke = function (key, e, ctrlr) {
      ...
      switch (key) {
        ...
        case 'Left':
          ctrlr.moveLeft();break;
        case 'Shift-Left':
          ctrlr.selectLeft();break;
        case 'Ctrl-Left':
          break;

        case 'Right':
          ctrlr.moveRight();break;
        case 'Shift-Right':
          ctrlr.selectRight();break;
        case 'Ctrl-Right':
          break;
  ...
  Controller.open(function (_) {
    ...
    _.delegateMouseEvents = function () {
      ...
      this.container.bind('mousedown.mathquill', function (e) {
        ...
        if (cursor.options.ignoreNextMousedown(e)) return;else cursor.options.ignoreNextMousedown = noop;
  ...
  var TextBlock = P(Node, function (_, super_) {
    ...
    _.seek = function (pageX, cursor) {
      ...
      if (approxPosition <= 0) cursor.insAtLeftEnd(this);else if (approxPosition >= textPc.text.length) cursor.insAtRightEnd(this);else cursor.insLeftOf(textPc.splitRight(approxPosition));
    ...
    _.blur = function (cursor) {
      ...
      if (this.textContents() === '') {
        this.remove();
        if (cursor[L] === this) cursor[L] = this[L];else if (cursor[R] === this) cursor[R] = this[R];
  ...
  */
  ...
  var SupSub = P(MathCommand, function (_, super_) {
    ...
    _.finalizeTree = function () {
      this.ends[L].write = function (cursor, ch) {
        if (cursor.options.autoSubscriptNumerals && this === this.parent.sub) {
          if (ch === '_') return;
          var cmd = this.chToCmd(ch);
          if (cmd instanceof Symbol) cursor.deleteSelection();else cursor.clearSelection().insRightOf(this.parent);
    ...
    _.deleteTowards = function (dir, cursor) {
      if (cursor.options.autoSubscriptNumerals && this.sub) {
        ...
        if (cmd instanceof Symbol) cmd.remove();else if (cmd) cmd.deleteTowards(dir, cursor.insAtDirEnd(-dir, this.sub));
  ...
  LatexCmds['\u222B'] = LatexCmds['int'] = LatexCmds.integral = P(SummationNotation, function (_, super_) {
    _.init = function () {
      var htmlTemplate = '<span class="mq-int mq-non-leaf">' + '<big>&int;</big>' + '<span class="mq-supsub mq-non-leaf">' + '<span class="mq-sup"><span class="mq-sup-inner">&1</span></span>' + '<span class="mq-sub">&0</span>' + '<span style="display:inline-block;width:0">&#8203</span>' + '</span>' + '</span>';
...
// removed by extract-text-webpack-plugin
module.exports = {"inputfield":"inputfield__3UrRE"};

/***/ })

});
//# sourceMappingURL=4.chunk.ffa9d.js.map